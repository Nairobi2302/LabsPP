...
public class DataPrinter {
    ...
    public void printMethod1(ArrayList<Fabric> txt) {
        ...
        for (Fabric fabric : txt) {
            System.out.println(fabric.getBrand() + " " + fabric.getType() + " " + fabric.getWeight());
        }
        System.out.println();
    }
    ...
    public void printMethod2(ArrayList<Fabric> txt) {
        ...
        txt.forEach(fabric -> System.out.println(fabric.getBrand() + " " + fabric.getType() + " " + fabric.getWeight()));
        System.out.println();
    }
